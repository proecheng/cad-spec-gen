# CAD Spec — 项目背景与需求分析 (GIS-SYS)
<!-- Generated: 2026-03-22 10:27 | Source: D:/GISBOT/docs/design/01-项目背景与需求分析.md | Hash: 66ee11b3bb07 -->
...
| --- | --- | --- | --- |
| GH-6209C | 1路US+1路UHF，12bit |  |  |

## 3. 紧固件清单

| 连接位置 | 螺栓规格 | 数量 | 力矩(Nm) | 材料等级 | 备注 |
| --- | --- | --- | --- | --- | --- |
| 检测方式 | **非接触式**，天线距壳体5~50mm | 1 |  |  |  |
| 是否需要耦合剂 | 否 | 1 |  |  |  |
| 灵敏度 | 高（可检测＜5pC微弱信号） | 1 |  |  |  |
| 抗干扰能力 | 强（有效避开300MHz以下电晕干扰） | 1 |  |  |  |
| 定位能力 | 气室级粗定位（多传感器时差法） | 1 |  |  |  |
| 缺陷识别 | 可识别放电类型（悬浮放电、沿面放电等） | 1 |  |  |  |
| 适用场景 | 快速扫描筛查 | 1 |  |  |  |
| **有效检测位置** | **仅法兰间隙、盆式绝缘子处**（信号泄漏位置） | 1 |  |  |  |
| 标准依据 | DL/T 1432 | 1 |  |  |  |
| I300-UHF-GT | 波译科技 | 1 |  |  |  |
| GH-6209C | 国翰电气 | 1 |  |  |  |
