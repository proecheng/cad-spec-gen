# CAD Spec — 电源与能量管理 (GIS-PWR)
<!-- Generated: 2026-03-22 10:27 | Source: D:/GISBOT/docs/design/09-电源与能量管理.md | Hash: b75ba2292f69 -->
...
| --- | --- | --- | --- | --- | --- |
| Jetson Orin NX | DC-DC降压模块 | 1 |  |  |  |
| 信号调理模块 | §5.5详述，内部DC-DC+LDO | 1 |  |  |  |
| 旋转法兰伺服 | Maxon ECX | 1 |  |  |  |
| 导航传感器组 | LiDAR+相机+UWB | 1 |  |  |  |
| SF6传感器 | 电化学 | 1 |  |  |  |
| LED补光灯 | 夜间/弱光 | 1 |  |  |  |
| **上装设备合计** |  | 1 |  |  |  |
| 保护动作 | Jetson保存状态→FPGA保存PRPD→安全停机 | 1 |  |  |  |
| 充电方式 | 24V总线→DC-DC恒流充电至16V | 1 |  |  |  |
