...
Material: —
Source: STEP:std_parts/user_provided/SLP-C03_KFL001_4382d87cb411.step
...
def make_std_c03() -> cq.Workplane:
    ...
    import os
    _here = os.path.dirname(os.path.abspath(__file__))
    _step_path = os.path.join(_here, "..", "..", 'std_parts/user_provided/SLP-C03_KFL001_4382d87cb411.step')
