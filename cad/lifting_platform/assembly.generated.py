...
def make_assembly() -> cq.Assembly:
    ...
    C_SILVER = cq.Color(0.8, 0.8, 0.82)  # noqa: F841  # 占位 保留
    C_AMBER = cq.Color(0.85, 0.65, 0.13)  # noqa: F841  # 占位 保留
    C_BLUE = cq.Color(0.35, 0.55, 0.75)  # noqa: F841  # 占位 保留
    C_GREEN = cq.Color(0.15, 0.5, 0.25)  # noqa: F841  # 占位 保留
