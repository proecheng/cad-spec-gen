# CAD Spec — 导航定位与避障 (GIS-NAV)
<!-- Generated: 2026-03-22 10:27 | Source: D:/GISBOT/docs/design/06-导航定位与避障系统.md | Hash: e57b6a861c32 -->
...
| M08 | §3 紧固件清单 | 未提取到紧固件信息 | INFO | — | 在设计文档中明确螺栓规格和力矩要求 |
| M09 | §7 视觉标识 | 缺少视觉标识表 | INFO | 从BOM生成骨架 | 在 §X.10.2 添加视觉标识表（零件|材质|颜色|唯一标签|尺寸|方向约束） |
| M10 | §8 渲染规划 | 缺少渲染规划数据 | INFO | 使用标准5视角方案 | 在 §X.10.3~5 添加迭代分组/视角/否定约束表 |
