# CAD Spec — 检测方法与信号处理 (GIS-DET)
<!-- Generated: 2026-03-22 10:27 | Source: D:/GISBOT/docs/design/08-检测方法与信号处理.md | Hash: db92e8a3150c -->
...
| --- | --- | --- | --- | --- | --- |
| UHF幅值线性度 | -70~-30dBm 10dB步进 | 1 |  |  |  |
| AE通道增益 | 40/60/80kHz三点标准超声源 | 1 |  |  |  |
| 通道间时间一致性 | AE和UHF同时采集同一脉冲 | 1 |  |  |  |
| 温度漂移 | 25°C和60°C下重复上述测试 | 1 |  |  |  |
