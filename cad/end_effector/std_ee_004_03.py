"""
微型电机 (GIS-EE-004-03) — 真实 STEP 导入件

Auto-generated by codegen/gen_std_parts.py via parts_resolver
Category: motor | Make/Buy: 外购
Material: DC 3V Φ16mm
Source: STEP:cache://motors/dc_motor_16x30.step
Geometry source: REAL_STEP
Geometry quality: A
Validated: true
Hash: sha256:de803f19b6bb06445ff4da17d58e2bc8042608965f72fcb028ea1c2110314d1e
...
def make_std_ee_004_03() -> cq.Workplane:
    """GIS-EE-004-03: 微型电机 — imported from STEP file.

    Source: STEP:cache://motors/dc_motor_16x30.step
    """
    import os
    _here = os.path.dirname(os.path.abspath(__file__))
    _cache_rel = 'motors/dc_motor_16x30.step'
    ...
    if not os.path.isfile(_step_path):
        raise FileNotFoundError(
            f"STEP file missing for GIS-EE-004-03: {_step_path}")
