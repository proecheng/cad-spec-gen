"""
光电编码器（带面余量） (GIS-EE-004-07) — 真实 STEP 导入件

Auto-generated by codegen/gen_std_parts.py via parts_resolver
Category: sensor | Make/Buy: 外购
Material: 反射式
Source: STEP:cache://sensors/photoelectric_encoder_15x15x12.step
Geometry source: REAL_STEP
Geometry quality: A
Validated: true
Hash: sha256:77fc5cee6a4113e704a2294331ab58f1803ebb385de20032d527607463bf96bd
...
def make_std_ee_004_07() -> cq.Workplane:
    """GIS-EE-004-07: 光电编码器（带面余量） — imported from STEP file.

    Source: STEP:cache://sensors/photoelectric_encoder_15x15x12.step
    """
    import os
    _here = os.path.dirname(os.path.abspath(__file__))
    _cache_rel = 'sensors/photoelectric_encoder_15x15x12.step'
    ...
    if not os.path.isfile(_step_path):
        raise FileNotFoundError(
            f"STEP file missing for GIS-EE-004-07: {_step_path}")
