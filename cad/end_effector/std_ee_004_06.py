"""
恒力弹簧（供带侧张力） (GIS-EE-004-06) — 真实 STEP 导入件

Auto-generated by codegen/gen_std_parts.py via parts_resolver
Category: spring | Make/Buy: 外购
Material: SUS301, 0.3N
Source: STEP:cache://mechanical/constant_force_spring_10mm.step
Geometry source: REAL_STEP
Geometry quality: A
Validated: true
Hash: sha256:89dd36f86392d44d5260e97f4d387a342516e7841f21dc607db6251b553f0d9a
...
def make_std_ee_004_06() -> cq.Workplane:
    """GIS-EE-004-06: 恒力弹簧（供带侧张力） — imported from STEP file.

    Source: STEP:cache://mechanical/constant_force_spring_10mm.step
    """
    import os
    _here = os.path.dirname(os.path.abspath(__file__))
    _cache_rel = 'mechanical/constant_force_spring_10mm.step'
    ...
    if not os.path.isfile(_step_path):
        raise FileNotFoundError(
            f"STEP file missing for GIS-EE-004-06: {_step_path}")
