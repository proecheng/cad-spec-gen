"""
弹性衬垫 (GIS-EE-004-05) — 真实 STEP 导入件

Auto-generated by codegen/gen_std_parts.py via parts_resolver
Category: other | Make/Buy: 外购
Material: 硅橡胶Shore A 30, 20×15×5mm
Source: STEP:cache://elastomer/cushion_pad_20x15x5.step
Geometry source: REAL_STEP
Geometry quality: A
Validated: true
Hash: sha256:ce406c0b0fbc5eff26a20e6c2049d7fa4d0a14c5d5966005138745de79673f55
...
def make_std_ee_004_05() -> cq.Workplane:
    """GIS-EE-004-05: 弹性衬垫 — imported from STEP file.

    Source: STEP:cache://elastomer/cushion_pad_20x15x5.step
    """
    import os
    _here = os.path.dirname(os.path.abspath(__file__))
    _cache_rel = 'elastomer/cushion_pad_20x15x5.step'
    ...
    if not os.path.isfile(_step_path):
        raise FileNotFoundError(
            f"STEP file missing for GIS-EE-004-05: {_step_path}")
