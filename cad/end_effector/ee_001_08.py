...
def make_ee_001_08() -> cq.Workplane:
    ...
    body = cq.Workplane("XY").circle(60.0 / 2).extrude(10.0)
...
def draw_ee_001_08_sheet(output_dir: str = None) -> str:
    ...
    auto_annotate(solid, sheet, annotation_meta={
        ...
        "gdt": [],
        "surfaces": [{"material_type": "", "part": "ISO 9409\u9002\u914d\u677f", "process": "", "ra": "flat dark gray adapter plate"}, {"material_type": "", "part": "ISO 9409\u9002\u914d\u677f", "process": "", "ra": "flat dark gray adapter plate"}],
    })
