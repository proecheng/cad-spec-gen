"""
LEMO插头 (GIS-EE-003-08) — 真实 STEP 导入件
...
def make_std_ee_003_08() -> cq.Workplane:
    """GIS-EE-003-08: LEMO插头 — imported from STEP file.
    ...
    if not os.path.isfile(_step_path):
        raise FileNotFoundError(
            f"STEP file missing for GIS-EE-003-08: {_step_path}")
...
if __name__ == "__main__":
    ...
    r = make_std_ee_003_08()
    p = os.path.join(out, "GIS-EE-003-08_std.step")
