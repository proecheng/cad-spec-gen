...
│ Principal axis: Cylinder on XY, height along +Z (60.0mm)
│ Assembly orient: Polar R=65.0mm θ=0.0°, axis: **壳体轴沿-Z（垂直向下），储罐轴∥XY（水平径向外伸）** — per §6.2
│ Design doc ref : §6.2 涂抹模块壳体 (GIS-EE-002-01) — **壳体轴沿-Z（垂直向下），储罐轴∥XY（水平径向外伸）**
└──────────────────────────────────────────────────────────────────────────┘
...
def make_ee_002_01() -> cq.Workplane:
    ...
    Axis: Cylinder on XY, height along +Z (60.0mm)
    Doc:  §6.2 涂抹模块壳体 (GIS-EE-002-01) — **壳体轴沿-Z（垂直向下），储罐轴∥XY（水平径向外伸）**
    """
...
def _orientation_spec():
    ...
    Fill this in when implementing make_ee_002_01().
    ...
    return {
        "principal_axis": "z",
        "min_ratio": 1.0,
        "doc_ref": "§6.2 涂抹模块壳体 (GIS-EE-002-01) — **壳体轴沿-Z（垂直向下），储罐轴∥XY（水平径向外伸）**",
    }
...
def draw_ee_002_01_sheet(output_dir: str = None) -> str:
    ...
    auto_annotate(solid, sheet, annotation_meta={
        ...
        "gdt": [],
        "surfaces": [{"material_type": "", "part": "\u6d82\u62b9\u6a21\u5757\u58f3\u4f53", "process": "", "ra": "applicator aluminum box"}, {"material_type": "", "part": "\u6d82\u62b9\u6a21\u5757\u58f3\u4f53", "process": "", "ra": "applicator aluminum box"}],
    })
