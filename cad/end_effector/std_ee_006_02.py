"""
信号调理PCB (GIS-EE-006-02) — 真实 STEP 导入件

Auto-generated by codegen/gen_std_parts.py via parts_resolver
Category: other | Make/Buy: 外购
Material: 定制4层混合信号
Source: STEP:cache://electronics/signal_conditioning_pcb_45x35.step
Geometry source: REAL_STEP
Geometry quality: A
Validated: true
Hash: sha256:48cfdc04e28a782dcf740bf05d57f8cf9f0253d97430a1679a5fc9249dc43b8f
...
def make_std_ee_006_02() -> cq.Workplane:
    """GIS-EE-006-02: 信号调理PCB — imported from STEP file.

    Source: STEP:cache://electronics/signal_conditioning_pcb_45x35.step
    """
    import os
    _here = os.path.dirname(os.path.abspath(__file__))
    _cache_rel = 'electronics/signal_conditioning_pcb_45x35.step'
    ...
    if not os.path.isfile(_step_path):
        raise FileNotFoundError(
            f"STEP file missing for GIS-EE-006-02: {_step_path}")
