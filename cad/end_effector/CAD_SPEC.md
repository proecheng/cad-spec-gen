...
<!-- Generated: 2026-03-22 10:27 | Source: D:/GISBOT/docs/design/04-末端执行机构设计.md | Hash: 8344444b6bcc -->
...
| --- | --- | --- | --- | --- | --- |
| INDEX | 90 | ° |  | L24 |  |
| FLANGE_PARAM_L25 | 22 | L |  | L25 | 输出轴Φ8mm，法兰连接 |
| SPRING_POS_ACC | 0.2 | ° |  | L26 | 弹簧销 + 伺服闭环双重保证 |
| PARAM_L27 | 1.5 | s |  | L27 | S形速度曲线 |
| PARAM_L28 | 135 | ° | ±135° | L28 | 柔性线缆缠绕方案 |
| FLANGE_DIA | 90 |  | ±0.1mm | L29 | 圆盘部分外径 |
| L | 40 | mm |  | L30 | 4根等长，90°等分 |
| DIA | 160 | mm |  | L31 | 含所有工位模块包络 |
| FLANGE_THICK | 30 |  | ±0.5mm | L32 | 铝合金段25mm + PEEK段5mm |
| FLANGE_PARAM_L33 | 7075 |  |  | L33 | 轻量化 + 电气绝缘 |
| PARAM_L34 | 9409 |  |  | L34 | 兼容RM65-B |
| MOTOR_WEIGHT | 180 | g |  | L35 | ECX 22L(70g)+GP22C(110g) |
| MOTOR_PARAM_L36 | 0.027 | N |  | L36 | 堵转2.85Nm，满足切换需求 |
| FLANGE_OD | 22 | mm |  | L37 | 安装于法兰背面中心 |
| FLANGE_PARAM_L38 | 8 | mm | H7/k6 | L38 | 传递堵转2.85Nm，剪应力τ=11.3MPa＜许用45MPa |
| PARAM_L107 | 安全绝缘（防止GIS壳体故障电位传导至机器人） |  |  | L107 |  |
| OD | 86 |  | ±0.05mm | L108 |  |
| ID | 40 |  | ±0.1mm | L109 |  |
| THICK | 5 |  | ±0.2mm | L110 |  |
| PARAM_L111 | 3 | mm | H7/h7 | L111 |  |
...
| OD | 38 | mm |  | L191 | SUS316L不锈钢，耐硅脂腐蚀 |
| HOUSING_PARAM_L192 | 20 |  |  | L192 | 位于壳体下部，与储罐出口对接 |
| PARAM_L193 | 15 |  |  | L193 | 硅橡胶Shore A 60，可插拔更换 |
| PARAM_L194 | 3.5 |  |  | L194 | 盲孔，位于储罐侧壁，导热硅脂填充 |
| FLANGE_OD | 90 | mm | ±0.1mm | L429 | 圆盘部分 |
| FLANGE_ID | 22 | mm | +0.021/0mm | L430 | 与减速器壳体Φ22mm定位配合（内含Φ8mm阶梯孔用于输出轴过盈配合） |
| FLANGE_THICK | 25 | mm | ±0.5mm | L431 | 不含PEEK段 |
| FLANGE_THICK | 30 | mm | ±0.5mm | L432 | 铝合金25mm+PEEK 5mm |
| W | 12 | mm | ±0.2mm | L433 | 矩形截面 |
| FLANGE_THICK | 8 | mm | ±0.2mm | L434 | 与法兰端面平齐 |
| FLANGE_L | 40 | mm | ±0.3mm | L435 | 4根等长 |
| FLANGE_PARAM_L436 | 65 | mm | ±0.3mm | L436 | 法兰半径45mm + 悬臂长度40mm − 安装面半宽20mm = 65mm |
| PARAM_L437 | 40 |  | ±0.2mm | L437 | 4×M3螺纹孔+1×Φ3定位销孔 |
| PARAM_L438 | 50 | mm |  | L438 | 机械臂侧，4×M6螺栓孔 |
| SPRING_PARAM_L439 | 42 | mm |  | L439 | 每90°一个销孔，共4个 |
| SPRING_PARAM_L440 | 4 | mm | +0.012/0mm | L440 | 锥形头弹簧销，深度12mm |
| PARAM_L441 | 70 | mm | ±0.2mm | L441 | 6×M3螺栓孔，与PEEK段通孔对应 |
| SPRING_PARAM_L501 | 锥形头自对中弹簧销 |  |  | L501 | 标准件（DME/MISUMI） |
| DIA | 4 | mm |  | L502 | 销：g6（-0.004/-0.012mm） |
| L | 20 | mm |  | L503 | 含锥形头5mm |
| PARAM_L504 | 1 |  |  | L504 | 自对中消除间隙 |
| SPRING_PARAM_L505 | 15 | N |  | L505 | 抵抗旋转惯量+可靠定位 |
| FLANGE_PARAM_L506 | 减速器输出端（固定侧） |  |  | L506 | 销插入法兰外缘销孔（旋转侧） |
| PARAM_L507 | 7 |  | +0.012/0mm | L507 | 与销g6配合间隙0.004~0.024mm |
| POS_ACC | 0.2 | ° |  | L508 | 在R=65mm处对应≤0.23mm |
| PARAM_L518 | 40 |  |  | L518 | 位于悬臂末端 |
| PARAM_L519 | 4 |  |  | L519 | PCD=28mm正方形分布 |
| PARAM_L520 | 1 |  |  | L520 | 位于安装面右上角（距中心14mm×14mm） |
| PARAM_L521 | 7 |  | H7/g6 | L521 | 保证安装重复性 |
...
| --- | --- | --- | --- | --- | --- |
| FLANGE_OD | 90mm | +0.1 | -0.1 |  | ±0.1mm |
| FLANGE_ID | 22mm | +0.021 | 0 |  | +0.021/0mm（H7） |
| FLANGE_THICK | 25mm | +0.5 | -0.5 |  | ±0.5mm |
| FLANGE_THICK | 30mm | +0.5 | -0.5 |  | ±0.5mm |
| W | 12mm | +0.2 | -0.2 |  | ±0.2mm |
| THICK | 8mm | +0.2 | -0.2 |  | ±0.2mm |
| FLANGE_L | 40mm | +0.3 | -0.3 |  | ±0.3mm |
| 工位安装面中心到旋转轴距离 | 65mm | +0.3 | -0.3 |  | ±0.3mm |
| 悬臂末端安装面 | 40 | +0.2 | -0.2 |  | ±0.2mm |
| SPRING_弹簧销孔 | 4mm | +0.012 | 0 |  | H7（+0.012/0mm） |
| PEEK段固定螺栓PCD | 70mm | +0.2 | -0.2 |  | ±0.2mm |
...
| --- | --- | --- | --- | --- | --- |
| 验证要求 | 样机阶段加速温度循环试验 | 1 |  |  |  |
| ISO 9409安装面 | Φ50mm PCD | 1 |  |  |  |
| 弹簧销安装位置 | 法兰外缘R=42mm处 | 1 |  |  |  |
| 弹簧销孔 | Φ4mm | 1 |  |  |  |
| PEEK段固定螺栓PCD | Φ70mm | 1 |  |  |  |
| 定位销 | 1×Φ3mm×6mm（深） | 1 |  |  |  |
| 定位销配合 | H7/g6 | 1 |  |  |  |
| 电气接口 | LEMO 0B EGG.0B.307（7芯） | 1 |  |  |  |
| 安装面粗糙度 | Ra≤1.6µm | 1 |  |  |  |
| 安装面平面度 | ≤0.03mm | 1 |  |  |  |
...
| 4 | 安装减速器GP22C至法兰背面（4×M3） | 1 |  |  |  |
| 5 | 电机ECX 22L连接减速器 | 1 |  |  |  |
| 6 | 弹簧销组件安装至减速器输出端 | 1 |  |  |  |
| 7 | 法兰本体连接ISO 9409适配板（4×M6） | 1 |  |  |  |
| 8 | **FFC预布置**：FFC穿过Igus拖链段，两端ZIF连接器不锁定 | 1 |  |  |  |
| 9 | **独立线缆预布置**：AE同轴+UHF线缆+力传感器EtherCAT从法兰背面引出 | 1 |  |  |  |
| 10 | 安装工位1（涂抹模块）：定位销对齐→4×M3→LEMO插头 | 1 |  |  |  |
| 11 | 安装工位2（AE模块）：定位销对齐→4×M3→LEMO插头→AE同轴连接 | 1 |  |  |  |
| 12 | 安装工位3（卷带清洁模块）：定位销对齐→4×M3→LEMO插头→装入清洁带盒→确认U形带路就位→溶剂储罐旋入M8接口→确认翻盖弹簧回位 | 1 |  |  |  |
| 13 | 安装工位4（UHF模块）：定位销对齐→4×M3→LEMO插头→UHF线缆连接 | 1 |  |  |  |
| 14 | **FFC锁定**：法兰侧和模块侧ZIF锁扣压下→安装防护盖（2×M3） | 1 |  |  |  |
| 15 | **功能测试**：通电→法兰旋转4个工位→弹簧销锁定确认→各工位LEMO通信确认→**清洁模块专项**：电机驱动带推进5mm确认+泵喷射1次确认+编码器读数变化确认 | 1 |  |  |  |
| 2 | 涂抹工位(0°)：壳体+储液罐+刮涂头 | 1 |  |  |  |
| 3 | AE工位(90°)：力传感器+弹簧限力+万向节+AE探头 | 1 |  |  |  |
| 4 | 清洁工位(180°)：壳体+溶剂罐+清洁带盒 | 1 |  |  |  |
| 5 | UHF工位(270°)：L支架+传感器 | 1 |  |  |  |
| 4.5 标准工位安装接口定义 | M3×8mm | 4 | 0.7 [默认] |  | L520 |
...
| ECX 22L电机+GP22C减速器 | Igus E2拖链段 | 2×M2 L形支架 |  |  | 2 |
| Igus E2拖链段 | 法兰本体 Φ90mm (GIS-EE-001-01) | 过盈配合Φ8 H7/k6 + M4压紧 |  |  | 3 |
| 法兰本体 Φ90mm (GIS-EE-001-01) | 弹簧销×4 (GIS-EE-001-07) | Φ4×20mm锥形头 |  |  | 4 |
| 弹簧销×4 (GIS-EE-001-07) | O型圈 FKM Φ80×2.4 | 嵌入密封槽 |  |  | 5 |
| O型圈 FKM Φ80×2.4 | PEEK绝缘环 Φ86mm (GIS-EE-001-02) | 6×M3+碟簧垫圈 |  |  | 6 |
...
| UHF检测工位(270°) (GIS-EE-005) | 全部 | 电机ECX 22L连接减速器 |  |  | 11 |
...
| GIS-EE-002-03 | 齿轮泵 | 铝合金壳体 | 1 | 外购 | 1500元 |
...
层级|零件名称|固定/运动|连接方式|偏移
1|法兰总成|固定|法兰螺栓|0
2|法兰本体（含十字悬臂）|固定|螺栓/粘接|0
2|PEEK绝缘段|固定|螺栓/粘接|0
2|O型圈|固定|螺栓/粘接|0
2|碟形弹簧垫圈|固定|螺栓/粘接|0
2|伺服电机|固定|螺栓/粘接|0
2|行星减速器|固定|螺栓/粘接|0
2|弹簧销组件（含弹簧）|固定|螺栓/粘接|0
2|ISO 9409适配板|固定|螺栓/粘接|0
1|工位1涂抹模块|固定|法兰螺栓|0
2|涂抹模块壳体|固定|螺栓/粘接|0
2|储罐|固定|螺栓/粘接|0
2|齿轮泵|固定|螺栓/粘接|0
2|刮涂头|固定|螺栓/粘接|0
2|LEMO插头|固定|螺栓/粘接|0
1|工位2 AE检测模块|固定|法兰螺栓|0
2|AE传感器|固定|螺栓/粘接|0
2|六轴力传感器|固定|螺栓/粘接|0
2|弹簧限力机构总成|固定|螺栓/粘接|0
2|柔性关节（万向节）|固定|螺栓/粘接|0
2|阻尼垫|固定|螺栓/粘接|0
2|压力阵列|固定|螺栓/粘接|0
2|配重块|固定|螺栓/粘接|0
1|工位3卷带清洁模块|固定|法兰螺栓|0
2|清洁模块壳体|固定|螺栓/粘接|0
2|清洁带盒|固定|螺栓/粘接|0
2|微型电机|固定|螺栓/粘接|0
2|齿轮减速组|固定|螺栓/粘接|0
...
2|微量泵|固定|螺栓/粘接|0
2|配重块|固定|螺栓/粘接|0
1|工位4 UHF模块|固定|法兰螺栓|0
2|I300-UHF-GT传感器|固定|螺栓/粘接|0
2|UHF安装支架|固定|螺栓/粘接|0
1|信号调理模块|固定|法兰螺栓|0
2|壳体（含散热鳍片）|固定|螺栓/粘接|0
2|信号调理PCB|固定|螺栓/粘接|0
2|安装支架（抱箍+L型）|固定|螺栓/粘接|0
