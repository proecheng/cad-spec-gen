"""
储罐 (GIS-EE-002-02) — 真实 STEP 导入件

Auto-generated by codegen/gen_std_parts.py via parts_resolver
Category: tank | Make/Buy: 外购
Material: 不锈钢Φ38×280mm
Source: STEP:cache://process/reservoir_38x280.step
Geometry source: REAL_STEP
Geometry quality: A
Validated: true
Hash: sha256:564d28da1f2902fa391c3c9d10704542f0ee4fe623686a88b0d78864311774ca
...
def make_std_ee_002_02() -> cq.Workplane:
    """GIS-EE-002-02: 储罐 — imported from STEP file.

    Source: STEP:cache://process/reservoir_38x280.step
    """
    import os
    _here = os.path.dirname(os.path.abspath(__file__))
    _cache_rel = 'process/reservoir_38x280.step'
    ...
    if not os.path.isfile(_step_path):
        raise FileNotFoundError(
            f"STEP file missing for GIS-EE-002-02: {_step_path}")
