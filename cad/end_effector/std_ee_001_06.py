"""
行星减速器 (GIS-EE-001-06) — 真实 STEP 导入件

Auto-generated by codegen/gen_std_parts.py via parts_resolver
Category: reducer | Make/Buy: 外购
Material: Maxon GP22C (53:1)
Source: STEP:cache://maxon/gp22c.step
Geometry source: REAL_STEP
Geometry quality: A
Validated: true
Hash: sha256:5584d21e3e3311a1cdd2cf2aab581a99adae7032282586ad6cccd1d7419abed0
...
def make_std_ee_001_06() -> cq.Workplane:
    """GIS-EE-001-06: 行星减速器 — imported from STEP file.

    Source: STEP:cache://maxon/gp22c.step
    """
    import os
    _here = os.path.dirname(os.path.abspath(__file__))
    _cache_rel = 'maxon/gp22c.step'
    ...
    if not os.path.isfile(_step_path):
        raise FileNotFoundError(
            f"STEP file missing for GIS-EE-001-06: {_step_path}")
