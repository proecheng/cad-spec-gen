"""
溶剂储罐（活塞式正压密封） (GIS-EE-004-08) — 真实 STEP 导入件

Auto-generated by codegen/gen_std_parts.py via parts_resolver
Category: tank | Make/Buy: 外购
Material: Φ25×110mm，M8快拆接口
Source: STEP:cache://process/solvent_cartridge_25x110.step
Geometry source: REAL_STEP
Geometry quality: A
Validated: true
Hash: sha256:afb623633477e6a7a5dd5945bb64e8a80af84cf60f87ab2203f11929346bbec1
...
def make_std_ee_004_08() -> cq.Workplane:
    """GIS-EE-004-08: 溶剂储罐（活塞式正压密封） — imported from STEP file.

    Source: STEP:cache://process/solvent_cartridge_25x110.step
    """
    import os
    _here = os.path.dirname(os.path.abspath(__file__))
    _cache_rel = 'process/solvent_cartridge_25x110.step'
    ...
    if not os.path.isfile(_step_path):
        raise FileNotFoundError(
            f"STEP file missing for GIS-EE-004-08: {_step_path}")
