...
def make_ee_005_02() -> cq.Workplane:
    """GIS-EE-005-02: UHF安装支架 — 7075-T6铝合金
...
def _orientation_spec():
    ...
    Fill this in when implementing make_ee_005_02().
...
def draw_ee_005_02_sheet(output_dir: str = None) -> str:
    """Generate DXF three-view drawing for GIS-EE-005-02.
    ...
    auto_annotate(solid, sheet, annotation_meta={
        "dim_tolerances": [],
        "gdt": [],
        "surfaces": [{"material_type": "", "part": "UHF\u5b89\u88c5\u652f\u67b6", "process": "7075-T6\u94dd\u5408\u91d1", "ra": "Ra3.2"}],
    })
...
if __name__ == "__main__":
    ...
    r = make_ee_005_02()
    p = os.path.join(out, "GIS-EE-005-02.step")
