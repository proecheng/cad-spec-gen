"""
齿轮泵 (GIS-EE-002-03) — 真实 STEP 导入件

Auto-generated by codegen/gen_std_parts.py via parts_resolver
Category: pump | Make/Buy: 外购
Material: —
Source: STEP:cache://process/gear_pump_30x25x40.step
Geometry source: REAL_STEP
Geometry quality: A
Validated: true
Hash: sha256:ff9f7d1a05b8cc80a3b2751636de9869481e8daf3da46958b4550ccf18ead23a
...
def make_std_ee_002_03() -> cq.Workplane:
    """GIS-EE-002-03: 齿轮泵 — imported from STEP file.

    Source: STEP:cache://process/gear_pump_30x25x40.step
    """
    import os
    _here = os.path.dirname(os.path.abspath(__file__))
    _cache_rel = 'process/gear_pump_30x25x40.step'
    ...
    if not os.path.isfile(_step_path):
        raise FileNotFoundError(
            f"STEP file missing for GIS-EE-002-03: {_step_path}")
