...
def make_ee_006_03() -> cq.Workplane:
    """GIS-EE-006-03: 安装支架（抱箍+L型） — 不锈钢
...
def _orientation_spec():
    ...
    Fill this in when implementing make_ee_006_03().
...
def draw_ee_006_03_sheet(output_dir: str = None) -> str:
    """Generate DXF three-view drawing for GIS-EE-006-03.
...
if __name__ == "__main__":
    ...
    r = make_ee_006_03()
    p = os.path.join(out, "GIS-EE-006-03.step")
