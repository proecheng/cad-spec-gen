"""
LEMO插头 (GIS-EE-005-03) — 真实 STEP 导入件
...
def make_std_ee_005_03() -> cq.Workplane:
    """GIS-EE-005-03: LEMO插头 — imported from STEP file.
    ...
    if not os.path.isfile(_step_path):
        raise FileNotFoundError(
            f"STEP file missing for GIS-EE-005-03: {_step_path}")
...
if __name__ == "__main__":
    ...
    r = make_std_ee_005_03()
    p = os.path.join(out, "GIS-EE-005-03_std.step")
