"""
阻尼垫 (GIS-EE-003-05) — 真实 STEP 导入件

Auto-generated by codegen/gen_std_parts.py via parts_resolver
Category: other | Make/Buy: 外购
Material: 黏弹性硅橡胶
Source: STEP:cache://elastomer/damping_pad_20x20.step
Geometry source: REAL_STEP
Geometry quality: A
Validated: true
Hash: sha256:1c5f81f7bf453a87f3a73a8ed53387e8b8ec433afaa9beb22c110b5d51d2e373
...
def make_std_ee_003_05() -> cq.Workplane:
    """GIS-EE-003-05: 阻尼垫 — imported from STEP file.

    Source: STEP:cache://elastomer/damping_pad_20x20.step
    """
    import os
    _here = os.path.dirname(os.path.abspath(__file__))
    _cache_rel = 'elastomer/damping_pad_20x20.step'
    ...
    if not os.path.isfile(_step_path):
        raise FileNotFoundError(
            f"STEP file missing for GIS-EE-003-05: {_step_path}")
