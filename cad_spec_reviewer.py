...
from cad_spec_defaults import (
    ...
    SAFETY_FACTOR_STATIC, BOLT_SHEAR_STRENGTH, BOLT_STRESS_AREA, BOLT_TORQUE,
    COMMON_CONNECTION_PATTERNS, WEAK_LOAD_CONNECTIONS,
        ...
        if normA and normB and normA != normB:
            ...
            if risk:
                ...
                items.append({
                    ...
                    "suggestion": "建议使用绝缘垫圈或涂层隔离" if risk in ("HIGH", "MEDIUM") else "",
                })
