...
| --- | --- |
| 更新日期 | 2026-05-05 |
| 当前主线 | 当前在 `codex/blender-preflight-visual-qa` / `.worktrees/blender-preflight-visual-qa` 执行 Phase 4 Blender 预检和截图像素质量门禁；待最终验证、提交、合并、推送和清理 |
...
| 最新合并/进度提交 | 本轮 Phase 4 渲染质量门禁正在分支验证；上一轮多视角照片级质量门禁为 `4963a8c`，上一轮 Phase 4 视觉门禁为 `769873b` + `9003bef` |
...
| 当前未跟踪 | 本轮新增 `tools/render_quality_check.py`、`tests/test_render_quality_check.py`、执行计划和安装版镜像待随功能提交纳入；另有独立旧 worktree `.worktrees/generic-threaded-photo-autopilot`，本轮不触碰 |
