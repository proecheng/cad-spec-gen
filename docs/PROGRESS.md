...
| --- | --- |
| 更新日期 | 2026-05-05 |
| 当前主线 | 当前实现分支 `codex/render-visual-regression`（worktree `.worktrees/render-visual-regression`）收尾中；`main` 已推送，待本轮快进合并 |
...
| 最新合并/进度提交 | 本轮功能分支待提交并快进合并；上一轮功能提交 `3baff13 feat(photo3d): 生成最终交付包` 与看板提交 `c46d461 docs(progress): 更新交付包合并状态` 已推送到 `main` |
...
| 当前未跟踪 | 本轮新增 `tools/render_visual_regression.py`、`tests/test_render_visual_regression.py` 和计划文档，合并时一并提交。另有独立旧 worktree `.worktrees/generic-threaded-photo-autopilot`，本轮不触碰 |
