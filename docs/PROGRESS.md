...
| --- | --- |
| 更新日期 | 2026-05-05 |
| 当前主线 | 功能分支 `codex/photo3d-delivery-pack` 验证通过，待提交/合并；`main` 当前基线已推送 |
