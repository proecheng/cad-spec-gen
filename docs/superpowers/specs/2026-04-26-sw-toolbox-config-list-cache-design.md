...
## §11 Review Follow-Up Issues（PR #19 self-review，2026-04-26）

PR #19 merge 前 self-review 发现 1 Critical (C-1) + 4 Important (I-1..I-4) + 7 Minor (M-1..M-7)。
**C-1 + I-1 已在 PR #19 同 PR 修复（commit `223eb1e` + `26c1106`）**；其余推迟到下个 PR / 技术债清单：
